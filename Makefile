...
PHP_VERSIONS?=php-8.0-alpine php-8.1-alpine php-8.2-alpine php-8.3-alpine php-8.4-alpine php-8.5-alpine
NODE_VERSIONS?=node-16-alpine node-18-alpine node-20-alpine node-22-alpine node-24-alpine
